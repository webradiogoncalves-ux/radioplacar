    ...
    <main className="screen home-screen rpf-home">
      ...
      <section className="home-block">
        <div
          style={{
            background: "#030604",
            border: "1px solid rgba(69,255,115,.35)",
            borderRadius: 18,
            overflow: "hidden",
        ...
        >
          ...
          <div
            style={{
              ...
              padding: "10px 13px",
              background:
                "linear-gradient(90deg,#061009,#101712,#061009)",
          ...
          <div
            style={{
              background:
                "radial-gradient(circle at 35% 40%,#17341f,#08110b 42%,#020403 82%)",
            }}
          >
            {heroMatch ? (
              <>
                ...
                <div
                  style={{
                    padding: "8px 12px",
                    background:
                      "linear-gradient(90deg,#45ff73,#22c94f)",
                    color: "#021006",
                  }}
                >
                  <small
